...
$api_key = 'Insert your SauceNAO API key here';
$image_url = 'Insert the image URL here'; // The image MUSTN'T use HTTPS

$json = file_get_contents("http://saucenao.com/search.php?db=5,9,12,21,22,25,26,34,36&api_key=$api_key&output_type=2&numres=6&url=$image_url");
